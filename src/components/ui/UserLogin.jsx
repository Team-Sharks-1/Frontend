...
import { Button } from './Button'; // Assuming you have the Button component in the same directory as before
...
const UserLogin = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Here you can add the logic to handle login, like calling an API endpoint
    console.log('Logging in with', email, password);

    // Navigate to the desired page after successful login
    navigate('/dashboard'); // Replace with the actual route for the user's dashboard or homepage
  };
