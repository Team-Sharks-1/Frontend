  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main>
        ...
        <section id="how-it-works" className="bg-gray-50 py-16">
          <div className="container mx-auto px-4">
            ...
            <p className="text-center text-gray-700">UrbanConnect provides a fast and simple way to book home services.</p>
          </div>
        </section>
        ...
        <section id="about" className="py-16">
          <div className="container mx-auto px-4">
            ...
            <p className="text-center text-gray-700">UrbanConnect is committed to connecting customers with verified professionals in their area, ensuring quality service and satisfaction.</p>
          </div>
        </section>
      </main>
      ...
      <footer className="bg-blue-600 text-white py-4">
        <div className="container mx-auto px-4 text-center">
          <p>&copy; 2024 UrbanConnect. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
